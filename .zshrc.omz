...
# Automatically create or attach to new session when shell starts
# This must be BEFORE p10k setup, see https://github.com/zellij-org/zellij/issues/1736
# if [[ -z "$ZELLIJ" ]]; then
...
# We use eza for ll'ish commands so we don't need any colors
