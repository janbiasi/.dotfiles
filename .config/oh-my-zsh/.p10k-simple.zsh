# Generated by Powerlevel10k configuration wizard on 2023-12-17 at 15:13 CET.
...
# 24h time, angled separators, blurred heads, flat tails, 2 lines, dotted, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=005
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%006F'   # green foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=008
