...
export TRUE_BLACK=0xff000000
# Color Palette -- Catppuccin Macchiato
# export BLACK=0xff181926
export BLACK=0xff131020
export BLACK_2=0xff232634
export BLACK_3=0xff181926
...
export ACCENT_COLOR=$SKY

# General bar colors
export BAR_COLOR=$TRANSPARENT #$GREY # Grey bar
